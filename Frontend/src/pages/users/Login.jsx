...
function Login() {
  ...
  return (
    ...
    >
      <div className="w-[100%]  bg-[#A9A1EB33] rounded-[20px] flex items-center justify-center mx-[24px]">
        <div className="w-[100%] mx-[20px] text-[20px] font-bold text-center flex flex-col gap-[40px]  ">
            ...
            <div className="flex flex-col gap-[8px]">
              ...
              <div className="relative w-full">
                ...
                >
                  ...
                  <option value="1" className="text-[#111111B2]/90">
                    Team 1
                  </option>
                  <option value="2" className="text-[#111111B2]/90">
                    Team 2
                  </option>
                  <option value="3" className="text-[#111111B2]/90">
                    Team 3
                  </option>
                  <option value="4" className="text-[#111111B2]/90">
                    Team 4
                  </option>
                </select>
              </div>
