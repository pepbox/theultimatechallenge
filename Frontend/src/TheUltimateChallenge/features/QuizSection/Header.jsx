    ...
    return (
        <>
            <header className='absolute top-0 left-0 w-[100%] h-[100px] bg-gradient-to-t from-[#595297]/50 to-[#23203E]/50 text-white rounded-b-[20px] font-mono backdrop-blur-[10px] flex flex-col items-center justify-center pt-1'>
                ...
                <div className='absolute top-[81px] right-[24px] w-[130px] h-[32px] rounded-[20px] flex items-center   bg-gradient-to-l from-[#595297] to-[#23203E]/70 backdrop-blur-[10px] z-10'>
                    <div className='mx-auto flex gap-2 py-1 pl-2 pr-1 items-center'>
                ...
                <div className='absolute top-[100px] left-1/2 -translate-x-1/2  w-[153px] h-[47px] rounded-b-[20px]  flex flex-col  bg-gradient-to-t from-[#595297]/60 to-[#23203E/70] backdrop-blur-[10px] border-b-[1px] border-white  '>
