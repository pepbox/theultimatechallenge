  ...
  return (
    <div className='text-white px-4 py-8'>
      ...
      {yourTeam ? (
        ...
        <div className='bg-[#2d2a46] rounded-lg p-6 text-center mb-8'>
          <p className='text-purple-200 text-sm'>No team data available. Please verify your team session login.</p>
        </div>
      )}
